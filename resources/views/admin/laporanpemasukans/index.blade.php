         ...
         <div class="col-md-12">
          <div class="panel panel-success">
            <div class="panel-heading">        
              <form class="form-inline" action="{{route('admin.laporanpemasukans.show_range')}}" method="get">
              ...
              <form action="{{route('admin.laporanpemasukans.show_weekly')}}" method="get">
                <div class="form-group ml-2">
            ...
            <table class=" table table-bordered table-striped table-hover datatable">
                ...
                @foreach($period as $date)
                    ...
                    <td>
                      <table>
                        <tbody>
                        @foreach(App\Saldo_Masuk::getSaldoMasuk($date->format('Y-m-d')) as $saldo_masuk)
                        <tr>
                          <td>{{App\Pengguna::showRupiah($saldo_masuk->saldo ?? '') }}</td>
                          <td>{{ $saldo_masuk->Pengguna->nama ?? ''}}</td>
                          <td>{{ $saldo_masuk->Pengguna->Request_Penjual->Fakultas->nama ?? ''}}</td>
                        </tr>
