...
class PesananProsesController extends Controller
{
    public function index()
    {
        ...
        ->where('detail_pesanan.status','diproses')
        ->get();

        return view('admin.pesananprosess.index', compact('pesanan'));
    }
    ...
    public function show($id_pesanan)
    {
        ...
        return view('admin.pesananprosess.show', compact('id_pesanan','detail_pesanan'));
    }
