...
class LaporanSikubisController extends Controller{
    ...
    public function index()
    {
        ...
        // return $period;
        return view('admin.laporansikubiss.index', compact('period','tanggalawal','tanggalakhir'));        
    }
    public function show_range(Request $request)
    {
        ...
        $period = CarbonPeriod::create($tanggalawal,$tanggalakhir);
        // return $period;
        return view('admin.laporansikubiss.index', compact('tanggalawal','tanggalakhir','period'));        
    }
